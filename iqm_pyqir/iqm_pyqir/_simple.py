...
class SimpleModule:
    ...
    def __init__(
        ...
        self._module = iqm_pyqir.qir_module(
            context,
            name,
            qir_major_version=1,
            qir_minor_version=0,
        ...
        self._entry_point = iqm_pyqir.entry_point(
    ...
    def qubits(self) -> List[Value]:
        ...
        return [iqm_pyqir.qubit(self.context, id) for id in range(self._num_qubits)]

    @property
    def results(self) -> List[Value]:
        """The list of statically allocated results indexed by their numeric ID."""
        return [iqm_pyqir.result(self.context, id) for id in range(self._num_results)]
    ...
    def add_byte_string(self, value: bytes) -> Constant:
        ...
        """
        return iqm_pyqir.global_byte_string(self._module, value)
