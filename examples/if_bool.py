...
mod = iqm_pyqir.SimpleModule("if_bool", num_qubits=2, num_results=2)
...
a_eq_7 = mod.builder.icmp(iqm_pyqir.IntPredicate.EQ, a, iqm_pyqir.const(i32, 7))
...
b_sgt_a = mod.builder.icmp(iqm_pyqir.IntPredicate.SGT, b, a)
or_cond = mod.builder.or_(a_eq_7, b_sgt_a)

# Both the true and false branches can be specified.
b_ne_2 = mod.builder.icmp(iqm_pyqir.IntPredicate.NE, b, iqm_pyqir.const(i32, 2))
