...
class BasicQisBuilder:
    ...
    def array_record_output(self, num_elements: Value, label: Value) -> None: ...
    ...
    def result_record_output(self, result: Value, label: Value) -> None: ...
    ...
    def tuple_record_output(self, num_elements: Value, label: Value) -> None: ...
...
class SimpleModule:
    ...
    def add_global_string(self, value: bytes) -> Constant: ...
...
def const(ty: Type, value: Union[int, float]) -> Constant: ...
def const_getelementptr(constant: Constant, indices: Sequence[Value]) -> Constant: ...
def entry_point(
