...
class Builder:
    ...
    def icmp_neq(self, lhs: Value, rhs: Value) -> Value: ...

    def icmp_ugt(self, lhs: Value, rhs: Value) -> Value: ...

    def icmp_uge(self, lhs: Value, rhs: Value) -> Value: ...

    def icmp_ult(self, lhs: Value, rhs: Value) -> Value: ...

    def icmp_ule(self, lhs: Value, rhs: Value) -> Value: ...

    def icmp_sgt(self, lhs: Value, rhs: Value) -> Value: ...

    def icmp_sge(self, lhs: Value, rhs: Value) -> Value: ...

    def icmp_slt(self, lhs: Value, rhs: Value) -> Value: ...

    def icmp_sle(self, lhs: Value, rhs: Value) -> Value: ...
