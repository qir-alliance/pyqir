...
- The use `<llvm version>` is a placeholder for `llvm18-1` or `llvm19-1`.
- The use of `<llvm major>` is a placeholder for `181` or `191` corresponding to the LLVM releases.
